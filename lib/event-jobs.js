...
var assertOpts = require('./assert-opts')
...
EventJobs.prototype.isPublishEvent = function (eventName) {
  ...
  return assertOpts.doesQueueExist(this._publishedEvents, eventName);
};
...
EventJobs.prototype.isSubscribeEvent = function (eventName) {
  ...
  return assertOpts.doesQueueExist(this._subscribedEvents, eventName);
};
...
EventJobs.prototype._assertAndBindQueue = function (queueDef, cb) {
  debug('_assertAndBindQueue', queueDef.name, queueDef);
  var self = this;
